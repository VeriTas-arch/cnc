...
class Delta(bp.dyn.SynConn):
    def __init__(self, pre, post, conn, g_max=1.0, delay_step=0, E=0.0, **kwargs):
...
neu1 = bp.neurons.SpikeTimeGroup(
    1, times=[20, 60, 100, 140, 180], indices=[0, 0, 0, 0, 0]
)
neu2 = bp.neurons.HH(1, V_initializer=bp.init.Constant(-70.68))
syn1 = Delta(neu1, neu2, conn=bp.connect.All2All(), g_max=2.0)
